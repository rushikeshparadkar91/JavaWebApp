...
/**
 * Class with hard coded data for the blog table.
 * <p>NOTE: This class was created while setting up the environment for Notable take home test</p>
 * Currently not being used since I have directly connected the app to the mysql database and can fetch the data from the database.
 *
...
public class BlogMockedData {
    ...
    /**
     * Constructor for {@link BlogMockedData}.
     *
     * @return A static singleton instance of {@link BlogMockedData}.
     */
